...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return[\/\\\/[a-z]{2}\\\/$\/,\/\\\/[a-z]{2}\\\/paths\/,\/\\\/[a-z]{2}\\\/dashboard\/,\/\\\/[a-z]{2}\\\/membres\/,\/\\\/[a-z]{2}\\\/student-profile$\/,\/\\\/[a-z]{2}\\\/apprenticeship$\/,\/\\\/[a-z]{2}\\\/employers$\/,\/\\\/[a-z]{2}\\\/mentorship\/,\/\\\/[a-z]{2}\\\/student-welcome$\/,\/\\\/[a-z]{2}\\\/learning-journey-introduction$\/,\/\\\/[a-z]{2}\\\/path-start$\/,\/\\\/[a-z]{2}\\\/courses\\\/1603881-\/,\/\\\/.*\\\/subscriptions\\\/subscribe\/,\/\\\/[a-z]{2}\\\/application\/,\/\\\/[a-z]{2}\\\/register\/,\/\\\/[a-z]{2}\\\/login\/,\/\\\/[a-z]{2}\\\/cpf$\/,\/\\\/[a-z]{2}\\\/lp\/].reduce(function(b,\na){a=!!document.location.pathname.match(a);return b||a},!1)})();"]
    },{
      "function":"__j",
  ...
  "tags":[{
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Efbq(\"track\",\"Purchase\",{value:\"",["escape",["macro",87],7],"\",currency:\"EUR\",content_ids:\"",["escape",["macro",73],7],"\",content_type:\"product\",content_name:\"",["escape",["macro",86],7],"\",content_category:\"",["escape",["macro",74],7],"\"});\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":331
  ...
  "rules":[
    ...
    [["if",0,11],["add",5,82]],
    [["if",12,13,14,15],["add",6,81]],
    [["if",12,13,15,16],["add",6,78]],
    [["if",0,17],["unless",18,19,20,21],["add",7]],
    [["if",0,22],["add",8,15]],
    [["if",0,23],["add",9]],
    [["if",24,25,26],["add",10,72,73]],
    [["if",27],["add",12]],
    [["if",8,10,28],["add",13]],
    [["if",29],["add",14,111]],
    [["if",0,30],["add",15]],
    ...
    [["if",4,35,36],["add",19]],
    [["if",25,37,38],["add",20]],
    [["if",25,37,39,40],["add",21,108]],
    [["if",25,37,41,42,43],["add",21]],
    [["if",44,45,46],["add",22]],
    [["if",45,47,48],["add",23]],
    [["if",0,49],["add",24]],
    [["if",50],["add",25,109]],
    ...
    [["if",0,58],["add",67]],
    [["if",10,59],["add",69]],
    [["if",10,60,61],["add",70,77]],
    [["if",10,61,62],["add",70]],
    [["if",0,63],["add",71]],
    [["if",10,64],["add",74,86,87,105,106]],
    [["if",10,65],["add",79]],
    [["if",27,66,67],["add",80]],
    [["if",10,68,69],["add",83]],
    [["if",0,70,71],["add",84]],
    [["if",0,72],["add",85]],
    [["if",7,73],["add",88,102]],
    [["if",10,60,74],["add",89,90]],
    [["if",4,75,76],["add",91,93]],
    [["if",4,77,78],["add",92,94]],
    [["if",4,75,79],["add",95,96]],
    [["if",4,80,81],["add",97]],
    [["if",0,16],["add",98]],
    [["if",0,76],["add",99,104]],
    [["if",0,14],["add",100]],
    ...
    [["if",0,52],["block",52]],
    [["if",0,53],["unless",54],["block",52]],
    [["if",2,10],["unless",5],["block",83]],
    [["if",0,82],["block",98,100]]]
},
...
return null},Ff=!1;if(I.querySelectorAll)try{var Gf=I.querySelectorAll(":root");Gf&&1==Gf.length&&Gf[0]==I.documentElement&&(Ff=!0)}catch(a){}var Cf=Ff;var Hd={},T=null,Uf=Math.random();Hd.B="GTM-5WM9PV";Hd.Rb="6o0";Hd.Sd="";var Vf={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Wf="www.googletagmanager.com/gtm.js";
...
(y("require","ec","ec.js"),B());var O={hitType:"event",eventCategory:String(e.vtp_eventCategory||f.category),eventAction:String(e.vtp_eventAction||f.action),eventLabel:x(String,e.vtp_eventLabel||f.label),eventValue:x(Qa,e.vtp_eventValue||f.value)};z(L,O,!1);y("send",O);}else if("TRACK_SOCIAL"==e.vtp_trackType){}else if("TRACK_TRANSACTION"==e.vtp_trackType){y("require","ecommerce","//www.google-analytics.com/plugins/ua/ecommerce.js");var P=function(Q){return V("transaction"+Q,1)},sa=P("Id");y("ecommerce:addTransaction",{id:sa,affiliation:P("Affiliation"),revenue:P("Total"),
shipping:P("Shipping"),tax:P("Tax")});for(var la=P("Products")||[],M=0;M<la.length;M++){var J=la[M];y("ecommerce:addItem",{id:sa,sku:J.sku,name:J.name,category:J.category,price:J.price,quantity:J.quantity})}y("ecommerce:send");}else if("TRACK_TIMING"==e.vtp_trackType){}else if("DECORATE_LINK"==e.vtp_trackType){}else if("DECORATE_FORM"==e.vtp_trackType){}else if("TRACK_DATA"==e.vtp_trackType){}else{e.vtp_enableEcommerce&&(y("require","ec","ec.js"),B());if(e.vtp_doubleClick||"DISPLAY_FEATURES"==e.vtp_advertisingFeaturesType){var aa="_dc_gtm_"+String(e.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");y("require","displayfeatures",void 0,{cookieName:aa})}if("DISPLAY_FEATURES_WITH_REMARKETING_LISTS"==e.vtp_advertisingFeaturesType){var Ba="_dc_gtm_"+String(e.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,
...
c.vtp_gtmOnFailure()},c.vtp_gtmOnFailure));var v=W("dataLayer"),w=v&&v.hide;w&&(w.end||!0===w["GTM-5WM9PV"])&&(w[c.vtp_optimizeContainerId]=!0)}else K(c.vtp_gtmOnFailure)};Z.__opt=b;Z.__opt.g="opt";Z.__opt.h=!0;Z.__opt.priorityOverride=0}();
